...
void sysy2022parserParserInitialize() {
  ...
  auto staticData = std::make_unique<SysY2022ParserStaticData>(
    ...
    std::vector<std::string>{
      "", "'int'", "'float'", "'void'", "'const'", "'tensor'", "'if'", "'else'", 
    ...
    std::vector<std::string>{
      "", "INT", "FLOAT", "VOID", "CONST", "TENSOR", "IF", "ELSE", "WHILE", 
  ...
  static const int32_t serializedATNSegment[] = {
  	...
  	0,75,73,1,0,0,0,75,74,1,0,0,0,76,3,1,0,0,0,77,78,5,4,0,0,78,79,3,6,3,
  	...
  	0,0,0,92,90,1,0,0,0,92,91,1,0,0,0,93,7,1,0,0,0,94,95,5,5,0,0,95,96,7,
  	...
  	183,3,28,14,0,183,21,1,0,0,0,184,189,5,3,0,0,185,189,5,1,0,0,186,189,
