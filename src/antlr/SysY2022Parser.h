...
public:
  ...
  enum {
    RuleCompilationUnit = 0, RuleDecl = 1, RuleVectorDecl = 2, RuleConstDecl = 3, 
  ...
  class  VectorDeclContext : public antlr4::ParserRuleContext {
  public:
    VectorDeclContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
