...
| 2026-07-22 | OpenAI Codex | GEP-LSR-2: 实现受嵌套区域压力预算约束的多链仿射 GEP 递推；修复寄存器与栈混合位置之间的并行 PHI 搬运；使用 Ubuntu 24.04、RISC-V GCC 和 QEMU 验证固定快速集及代表性性能用例 | 本地寄存器单测和 13 个关键用例通过；官网完整正确性与性能评测待小组成员确认 |
