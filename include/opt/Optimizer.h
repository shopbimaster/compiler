...
bool inplaceMatrixBlocking(IR::Module* mod);
bool conditionalMatrixBlocking(IR::Module* mod);
...
bool transposeProvenanceLowering(IR::Module* mod);
bool affineRecursiveMemoization(IR::Module* mod);
...
bool deadGlobalStoreElimination(IR::Module* mod);
